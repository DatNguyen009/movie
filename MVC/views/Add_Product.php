                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="/DAT/Skincare/form_upload.php" method="post"
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <div class="add_infor">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" id="makeup"
                                                    name="radiocolor" value="makeup">
                                                <label class="custom-control-label" for="makeup">Makeup</label>
                                            </div>

                                            <!-- Default inline 3-->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" id="Skincare"
                                                    name="radiocolor" value="Skincare">
                                                <label class="custom-control-label" for="Skincare">Skincare</label>
                                            </div>
                                            <p>Ảnh sản phẩm</p>
                                            ...
                                            <p>Màu</p><span class="noteinadd" style="position: absolute;color: red;font-size: 13px;transform: translateY(-20px);">(có thể chọn nhiều cách nhau bởi dấu ,)</span>
                                            <input id="color" type="text" name="color" class="form-control"
                                                placeholder="đỏ,hồng">
                                            <p>Khuyến mãi</p>
                                            <span class="noteinadd" style="position: absolute;color: red;font-size: 13px;transform: translateY(-20px);">(vd: 0% chỉ cần nhập 0)</span>
